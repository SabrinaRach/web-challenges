...
switchValueButton.addEventListener("click", () => {
  const tempValueFirst = firstSwitchValueInput.value;
  const tempValueSecond = secondSwitchValueInput.value;
  firstSwitchValueInput.value = tempValueSecond;
  secondSwitchValueInput.value = tempValueFirst;
});
// --^-- End of Task 3 --^--
