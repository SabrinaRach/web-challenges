...
function hasAnimal(animals, animalName) {
  return animals
    .map((animal) => animal.toLowerCase()) // das array animals wird umgewandelt
    .includes(animalName.toLowerCase()); // wandelt die Nutzereingabe nach lowercase um und includes bekommt den umgewandelten string zum vergleich
}
